...
import {addTaskAC, removeTaskAC, tasksReducer, updateTaskAC} from "./state/tasksReducer";
...
function AppWithReducers() {
    ...
    function addTask(todoListId: string, title: string) {
        const newTask = {
            ...
            order: 0, addedDate: '', deadline: '', description: '',
            priority: TaskPriorityes.Low, startDate: '', todoListId
        }
        dispatchToTasks(addTaskAC(newTask))
    }

    function changeStatus(todoListId: string, taskId: string, isDone: boolean) {
        dispatchToTasks(updateTaskAC(todoListId, taskId, {status: isDone ? TaskStatuses.Completed : TaskStatuses.New}))
    }

    const changeTaskTitle = (todoListId: string, taskId: string, newTitle: string) => {
        dispatchToTasks(updateTaskAC(todoListId, taskId, {title: newTitle}))
    }
    ...
    const addTodolist = (title: string) => {
        const action = {id: v1(), title, addedDate: '', order: 0}
